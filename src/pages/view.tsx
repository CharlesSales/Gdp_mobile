      ...
      <View style={styles.main}>
        ...
        <View style={styles.ctas}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('PedidosAcaraje')}
          >
            <Text style={styles.primaryText}>Pedidos Acaraje</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.primary}
            onPress={() => navigation.navigate('PedidosRestaurante')}
          >
            <Text style={styles.primaryText}>Pedidos Restaurante</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.primary}
            onPress={() => navigation.navigate('PedidosGeral')}
          >
            <Text style={styles.primaryText}>Pedidos Geral</Text>
          </TouchableOpacity>
        </View>
      </View>
